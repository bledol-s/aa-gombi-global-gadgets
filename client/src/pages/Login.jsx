  ...
  const handleEmailLogin = async (e) => {
    ...
    try {
      ...
      if (err.code === 'auth/user-not-found') {
        setError(<>Account not found. Please <Link to="/signup">sign up</Link>.</>);
      } else {
          ...
          <div className="card">
            <div className="card-body">
              ...
              <form onSubmit={handleEmailLogin}>
                ...
                <button type="submit" className="btn btn-primary w-100"><i className="bi bi-envelope-fill me-2"></i>Login with Email</button>
              </form>
              <hr />
              <div className="text-center">
                ...
                {confirmationResult ? (
                  ...
                  <div className="mt-3">
                    ...
                    <button onClick={handlePhoneLogin} className="btn btn-info w-100"><i className="bi bi-telephone-fill me-2"></i>Login with Phone</button>
                  </div>
                )}
              </div>
            </div>
